    ...
    <div className='p-[6px]'>
      <ul className='flex justify-cente item opacity-70 gap-4'>
        <li className='hover:scale-105'>
          <a href='https://www.linkedin.com/in/yogesh-patade-97044a229/' target='_blank_'>
        ...
        <li className='hover:scale-105'>
          <a href='https://github.com/Yogeshp21' target='_blank_'>
        ...
        <li className='hover:scale-105'>
          <a href='https://www.instagram.com/its_yogesh_2105/' target='_blank_'>
